...
### Automation
- **n8n invoice approval workflow** — designed and documented an end-to-end automated invoice approval workflow in n8n, integrating AI extraction, JSON parsing, and Slack notifications with emoji-based approval routing. [View workflow sample (PDF)]() 
