...
- **User Manual for a government web application (KPITB)** — wrote a step-by-step user manual for KPITB's Company Evaluation Form, walking users through required documents, login, and all five form steps. [View User Manual (PDF)](Sanitized_User_manual_for_Company_evalution_form.pdf)
